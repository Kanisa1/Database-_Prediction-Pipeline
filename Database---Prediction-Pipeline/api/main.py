"""
FastAPI application for Loan Prediction System
Provides RESTful API endpoints for loan data management and ML predictions
"""
...
from .database import (
    ...
    LoanPrediction,
    LoanAnalytics,
    LoanFeature  # Only import if used for DB queries
)
from .models import (
