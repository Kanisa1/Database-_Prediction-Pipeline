#!/usr/bin/env python3
"""
Clean Data Import Script for Loan Prediction Pipeline
Imports CSV data into MySQL and MongoDB databases
"""
...
class DataImporter:
    ...
    def connect_mongodb(self):
        ...
        try:
            ...
            # Get database
            db_name = os.getenv('MONGO_DATABASE', 'loan_prediction_db')
    ...
    def import_to_mysql(self, df):
        ...
        try:
            ...
            logger.info("Cleared existing data from loan_applications table")
    ...
    def import_to_mongodb(self, df):
        ...
        try:
            ...
            logger.info("Cleared existing data from MongoDB loan_applications collection")
    ...
    def verify_import(self):
        ...
        # Check MySQL - using a different approach to avoid type issues
        if self.mysql_connection and self.mysql_connection.is_connected():
            ...
            logger.warning("MySQL connection not available for verification")
        ...
        if self.mongodb_db is not None:
            ...
            logger.warning("MongoDB connection not available for verification")
...
def main():
    ...
    print("=== Loan Prediction Data Import ===")
